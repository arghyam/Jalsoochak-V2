...
WHERE scheme_id IN (1001, 1002, 1003, 1004, 1005, 1006, 1007, 1008, 2001, 10101, 10102);
...
WHERE date_key BETWEEN 20260201 AND 20260220;
...
SELECT
    ...
    CASE
        WHEN EXTRACT(MONTH FROM d.full_date) >= 4 THEN EXTRACT(YEAR FROM d.full_date)::INT
        ELSE EXTRACT(YEAR FROM d.full_date)::INT - 1
    END AS fiscal_year
FROM generate_series(DATE '2026-02-01', DATE '2026-02-20', INTERVAL '1 day') AS d(full_date)
...
VALUES
    ...
    (1002, 33, 'Scheme MH-B', 33002, 93002, 72.26, 18.26,
     ...
     1, NOW(), NOW(), 62, 80, 80),
    (1003, 33, 'Scheme MH-C', 33003, 93003, 72.16, 18.14,
     110, 100, 110, 111, NULL, NULL, NULL,
     5100, 5000, 5100, 5110, NULL, NULL, NULL,
     1, NOW(), NOW(), 80, 100, 100),
    (1004, 33, 'Scheme MH-D', 33004, 93004, 72.18, 18.16,
     110, 100, 110, 111, NULL, NULL, NULL,
     5100, 5000, 5100, 5110, NULL, NULL, NULL,
     1, NOW(), NOW(), 76, 95, 95),
    (1005, 33, 'Scheme MH-E', 33005, 93005, 72.24, 18.24,
     110, 100, 110, 112, NULL, NULL, NULL,
     5100, 5000, 5100, 5120, NULL, NULL, NULL,
     1, NOW(), NOW(), 68, 88, 88),
    (1006, 33, 'Scheme MH-F', 33006, 93006, 72.28, 18.23,
     110, 100, 110, 112, NULL, NULL, NULL,
     5100, 5000, 5100, 5120, NULL, NULL, NULL,
     0, NOW(), NOW(), 64, 84, 84),
    (1007, 33, 'Scheme MH-G', 33007, 93007, 72.15, 18.18,
     110, 100, 110, 111, NULL, NULL, NULL,
     5100, 5000, 5100, 5110, NULL, NULL, NULL,
     1, NOW(), NOW(), 70, 90, 90),
    (1008, 33, 'Scheme MH-H', 33008, 93008, 72.27, 18.21,
     110, 100, 110, 112, NULL, NULL, NULL,
     5100, 5000, 5100, 5120, NULL, NULL, NULL,
     1, NOW(), NOW(), 66, 86, 86),
...
VALUES
    (1, 10101, 1101, 4800, DATE '2026-02-01', NOW(), NOW(), 1, 1),
    (1, 10101, 1101, 5050, DATE '2026-02-03', NOW(), NOW(), 1, 1),
    (1, 10102, 1101, 4100, DATE '2026-02-01', NOW(), NOW(), 1, 2),
    (1, 10102, 1101, 3950, DATE '2026-02-04', NOW(), NOW(), 1, 2),
    (33, 1001, 3301, 5000, DATE '2026-02-01', NOW(), NOW(), 1, 2),
    (33, 1001, 3301, 5200, DATE '2026-02-02', NOW(), NOW(), 1, 2),
    (33, 1001, 3301, 5300, DATE '2026-02-03', NOW(), NOW(), 1, 2),
    (33, 1001, 3301, 5100, DATE '2026-02-04', NOW(), NOW(), 1, 2),
    (33, 1001, 3301, 5400, DATE '2026-02-05', NOW(), NOW(), 1, 2),
    (33, 1001, 3301, 5250, DATE '2026-02-06', NOW(), NOW(), 1, 2),
    (33, 1001, 3301, 5450, DATE '2026-02-07', NOW(), NOW(), 1, 2),
    (33, 1001, 3301, 5350, DATE '2026-02-08', NOW(), NOW(), 1, 2),
    (33, 1001, 3301, 5500, DATE '2026-02-09', NOW(), NOW(), 1, 2),
    (33, 1001, 3301, 5600, DATE '2026-02-10', NOW(), NOW(), 1, 2),
    (33, 1001, 3301, 5480, DATE '2026-02-11', NOW(), NOW(), 1, 2),
    (33, 1001, 3301, 5550, DATE '2026-02-12', NOW(), NOW(), 1, 2),
    (33, 1001, 3301, 5700, DATE '2026-02-13', NOW(), NOW(), 1, 2),
    (33, 1001, 3301, 5650, DATE '2026-02-14', NOW(), NOW(), 1, 2),
    (33, 1002, 3301, 4000, DATE '2026-02-01', NOW(), NOW(), 1, 3),
    (33, 1002, 3301, 4050, DATE '2026-02-03', NOW(), NOW(), 1, 3),
    (33, 1002, 3301, 3980, DATE '2026-02-05', NOW(), NOW(), 1, 3),
    (33, 1002, 3301, 4100, DATE '2026-02-07', NOW(), NOW(), 1, 3),
    (33, 1002, 3301, 4200, DATE '2026-02-09', NOW(), NOW(), 1, 3),
    (33, 1002, 3301, 4150, DATE '2026-02-11', NOW(), NOW(), 1, 3),
    (33, 1002, 3301, 4250, DATE '2026-02-13', NOW(), NOW(), 1, 3),
    (33, 1003, 3301, 4300, DATE '2026-02-01', NOW(), NOW(), 1, 1),
    (33, 1003, 3301, 4420, DATE '2026-02-08', NOW(), NOW(), 1, 1),
    (33, 1004, 3301, 4400, DATE '2026-02-01', NOW(), NOW(), 1, 1),
    (33, 1005, 3301, 3900, DATE '2026-02-01', NOW(), NOW(), 1, 2),
    (33, 1006, 3301, 3800, DATE '2026-02-01', NOW(), NOW(), 1, 3),
    (33, 1007, 3301, 4500, DATE '2026-02-01', NOW(), NOW(), 1, 1),
    (33, 1008, 3301, 3950, DATE '2026-02-01', NOW(), NOW(), 1, 2),
    (34, 2001, 3401, 6000, DATE '2026-02-01', NOW(), NOW(), 1, 2),
    (34, 2001, 3401, 6150, DATE '2026-02-06', NOW(), NOW(), 1, 2);
